/*
This is the source code for syscall:stop_trace
The function is to stop tracing a task
...
static int sys_stop_trace(pid_t pid)
{
  ...
  {
    printk(KERN_INFO "STOP TRACE! Current thread:%d\n", tsk->pid);
    tsk->trace_flag = 0;
    tsk->wcounts = 0;
...
static int addsyscall_init(void)
{
  ...
  oldcall = (int (*)(void))(syscall[__NR_stop_trace]);
