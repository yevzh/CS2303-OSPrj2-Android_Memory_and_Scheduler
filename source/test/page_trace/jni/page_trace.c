/*
This is the test program for problem2: page trace
Use a for loop to compose write faults to a protected memory
Count the wcounts to verify our three syscalls
